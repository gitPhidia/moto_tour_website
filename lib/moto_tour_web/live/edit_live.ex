defmodule MotoTourWeb.EditLive do
    ...
    <a href={Routes.itineraire_path(@socket, :liste, @itineraire.idcircuit)}>Retour</a>
      ...
      <form id="itineraire-form" phx-submit="submit_itineraire">
        ...
        <div class="form-group d-flex align-items-center">
          ...
          <input type="text" name="depart" class="form-control" value={@itineraire.depart}/>
        </div>

        <div class="form-group d-flex align-items-center">
          <label style="width: 130px;">Lieu d'arriver</label>
          <input type="text" name="arriver" class="form-control" value={@itineraire.arriver}/>
        </div>

        <div class="form-group d-flex align-items-center">
          <label style="width: 130px;">Distance</label>
          <input type="text" name="distance" class="form-control" value={@itineraire.distance}/>
        </div>

        <div class="form-group" style="display: flex; align-items: center;">
          <label style="width: 130px;">Description</label>
          <textarea name="remarque" style="height: 200px;"><%= @itineraire.remarque %></textarea>
        </div>

        <input type="hidden" name="id" value={@id} class="form-control" />
        <input type="hidden" name="idcircuit" value={@itineraire.idcircuit} class="form-control" />
  ...
  "remarque" => remarque, "idcircuit" => idcircuit, "id" => id}, socket) do
    ...
    IO.inspect(itineraire_params, label: "params")
    changeset = Itineraires.change_itineraire(%Itineraire{}, itineraire_params)
    changeset2 = Itineraires.change_itineraire(itineraire, itineraire_params)
